public class SingleLinkedListPendulum {
    ...
    public static SingleLinkedListPendulum insert(SingleLinkedListPendulum list, int data)
    {
    ...
    public static void printList(SingleLinkedListPendulum list)
    {
    ...
    {
        SingleLinkedListPendulum list = new SingleLinkedListPendulum();
        list = insert(list, 1);
        list = insert(list, 2);
        list = insert(list, 3);
        list = insert(list, 4);
